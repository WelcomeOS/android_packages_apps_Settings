...
public class CustomBuildNumberDialogController {

    @VisibleForTesting
    static final int CUSTOM_BUILD_NUMBER_VALUE_ID = R.id.custom_build_number_value;

    private final FirmwareVersionDialogFragment mDialog;

    public CustomBuildNumberDialogController(FirmwareVersionDialogFragment dialog) {
        mDialog = dialog;
    }
